...
// Room for the centered title. Back at 36 after a stint at 22 (which gave
// the plot ~14px more height) - the title is centered on its real ink
// extents within this band, see draw_axes()'s title block in Display.cpp.
